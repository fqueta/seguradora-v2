...
class MenuPermissionSeederAdmin extends Seeder
{
    /**
     * Executa a inserção/atualização das permissões de menu para o grupo Administrador
     */
    public function run(): void
    {
        $admin = Permission::where('name', 'Administrador')->first();
        if (!$admin) {
            $this->command->error('Permissão "Administrador" não encontrada. Execute PermissionSeeder primeiro.');
            return;
        }
        ...
        $this->command->info('MenuPermissionSeederAdmin aplicado para o grupo Administrador.');
    }
}
