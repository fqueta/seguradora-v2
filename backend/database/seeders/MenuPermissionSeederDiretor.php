...
class MenuPermissionSeederDiretor extends Seeder
{
    /**
     * Aplica permissões de menu para o grupo Diretor conforme dataset fornecido.
     */
    public function run(): void
    {
        $role = Permission::firstOrCreate(
            ['name' => 'Diretor'],
            [
                'description' => 'Diretoria do sistema',
                'redirect_login' => '/home',
                'active' => 's',
                'excluido' => 'n',
                'deletado' => 'n',
        ...
        $this->command->info('MenuPermissionSeederDiretor aplicado para o grupo Diretor.');
    }
}
