...
class MenuPermissionSeederConsultor extends Seeder
{
    public function run(): void
    {
        $role = Permission::where('name', 'Consultor')->first();
        if (!$role) {
            $this->command->error('Permissão "Consultor" não encontrada. Execute PermissionSeeder primeiro.');
            return;
        }
        ...
        $this->command->info('MenuPermissionSeederConsultor aplicado para o grupo Consultor.');
    }
}
