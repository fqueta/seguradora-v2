...
class MenuPermissionSeederGerente extends Seeder
{
    public function run(): void
    {
        $role = Permission::where('name', 'Gerente')->first();
        if (!$role) {
            $this->command->error('Permissão "Gerente" não encontrada. Execute PermissionSeeder primeiro.');
            return;
        }
        ...
        $this->command->info('MenuPermissionSeederGerente aplicado para o grupo Gerente.');
    }
}
