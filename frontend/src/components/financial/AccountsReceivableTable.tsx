...
interface AccountsReceivableTableProps {
  ...
  groupBy?: 'none' | 'category' | 'paymentMethod' | 'customer';
  startDate?: string;
  endDate?: string;
  search?: string;
}
 ...
 */
export const AccountsReceivableTable: React.FC<AccountsReceivableTableProps> = ({ categories, groupBy = 'none', startDate, endDate, search }) => {
