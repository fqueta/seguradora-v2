...
export const AccountReceivableForm: React.FC<AccountReceivableFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (account) {
        ...
        await financialService.accountsReceivable.update(account.id, payload);
        toast.success('Conta a receber atualizada com sucesso!');
      } else {
        // Criar nova conta
        await financialService.accountsReceivable.create(payload);
  ...
  const categoryOptions = useComboboxOptions(incomeCategories, 'id', 'name');
